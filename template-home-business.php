        ...
        <div class="ross-container">
            <div class="ross-hero-content">
                <h1 class="ross-hero-title">
                    <?php echo get_post_meta(get_the_ID(), '_ross_hero_title', true) ?: __('Transform Your Business Today', 'ross-theme'); ?>
                </h1>
                <p class="ross-hero-subtitle">
                    <?php echo get_post_meta(get_the_ID(), '_ross_hero_subtitle', true) ?: __('Professional solutions tailored to your needs. We help businesses grow and succeed in the digital age.', 'ross-theme'); ?>
                </p>
                <div class="ross-hero-buttons">
                    <a href="<?php echo get_post_meta(get_the_ID(), '_ross_hero_primary_link', true) ?: '#contact'; ?>" class="ross-btn ross-btn-primary">
                        <?php echo get_post_meta(get_the_ID(), '_ross_hero_primary_text', true) ?: __('Get Started', 'ross-theme'); ?>
                    </a>
                    <a href="<?php echo get_post_meta(get_the_ID(), '_ross_hero_secondary_link', true) ?: '#services'; ?>" class="ross-btn ross-btn-secondary">
                        <?php echo get_post_meta(get_the_ID(), '_ross_hero_secondary_text', true) ?: __('Learn More', 'ross-theme'); ?>
                    </a>
                </div>
            </div>
        </div>
