...
$options = ross_get_advanced_topbar_options();
        ...
        foreach ($sections as $section) {
            ...
            if (!isset($options[$key]) || empty($options[$key])) {
                ...
                if ($section === 'left') {
                    ...
                    echo '<span class="ross-topbar-item"><i class="fa fa-phone"></i> ' . __('+1-234-567-8900', 'ross-theme') . '</span>';
                    echo '</div>';
                } elseif ($section === 'right') {
                    echo '<div class="ross-topbar-' . esc_attr($section) . '">';
                    echo '<span class="ross-topbar-item"><i class="fa fa-envelope"></i> ' . __('info@example.com', 'ross-theme') . '</span>';
                    echo '</div>';
                }
                continue;
            }
