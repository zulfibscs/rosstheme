<?php
/**
 * Template Name: Classic Static Header
 * Description: Classic static header template with traditional design
 */

// Get theme options
$options = get_option('ross_theme_header_options', array());
$config = isset($options['classic-static']) ? $options['classic-static'] : array();

// Merge with defaults
$defaults = include get_template_directory() . '/inc/features/header/templates/classic-static.php';
