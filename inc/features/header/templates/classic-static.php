<?php
/**
 * Header Template: Classic Static
 * Complete static header with all features from the provided code
 * Fully responsive with mobile-first design and advanced functionality
 */
return array(
    'id' => 'classic-static',
    'title' => 'Classic Static',
    'description' => 'Complete static header with top bar, announcement, search, CTA, and mobile drawer - matches exact HTML structure',
    'icon' => '📄',
    'preview_image' => 'static-complete.png',
