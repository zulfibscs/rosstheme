 ...
 *
 * Controls global theme settings and appearance through the WordPress
 * Settings API. Manages sections for layout, colors, typography, buttons,
 * media, blog settings, performance, and custom scripts.
 *
 * @package RossTheme\Admin
 * @since 1.0.0
...
class RossGeneralOptions {
    ...
    /**
     * Constructor - Initialize the general options
     *
     * Sets up hooks for registering settings and enqueuing admin scripts.
     * Loads existing options from database.
     *
     * @since 1.0.0
     */
    ...
    /**
     * Enqueue admin scripts and styles for general options page
     *
     * Loads necessary WordPress core scripts (media library, color picker)
     * and theme-specific assets only on the general options page.
     *
    ...
    public function enqueue_general_scripts($hook) {
        if ('toplevel_page_ross-theme-general' === $hook) {
            // CRITICAL: Enqueue media library FIRST for image uploads
            wp_enqueue_media();

            // Then jQuery for DOM manipulation
            wp_enqueue_script('jquery');

            // Color picker for theme color settings
            wp_enqueue_style('wp-color-picker');
            wp_enqueue_script('wp-color-picker');

            // Theme-specific uploader script
    ...
    /**
     * Register general theme settings with WordPress Settings API
     *
     * Sets up the main settings group and registers all option sections
     * and fields for the general theme options page.
     *
     * @return void
     *
     * @since 1.0.0
    ...
    private function add_layout_section() {
        ...
        add_settings_field(
            'container_width',
            __('Container Width (px)', 'ross-theme'),
        ...
        add_settings_field(
            'content_spacing',
            __('Content Spacing (px)', 'ross-theme'),
        ...
        add_settings_field(
            ...
            __('Global Border Radius (px)', 'ross-theme'),
        ...
        add_settings_field(
            'enable_preloader',
            __('Enable Page Preloader', 'ross-theme'),
    ...
    private function add_colors_section() {
        ...
        add_settings_field(
            'background_color',
            __('Background Color', 'ross-theme'),
    ...
    private function add_typography_section() {
        ...
        add_settings_field(
            'base_font_family',
            __('Base Font Family', 'ross-theme'),
        ...
        add_settings_field(
            'base_font_size',
            __('Base Font Size (px)', 'ross-theme'),
        ...
        add_settings_field(
            'base_line_height',
            __('Base Line Height', 'ross-theme'),
        ...
        add_settings_field(
            'heading_font_family',
            __('Heading Font Family', 'ross-theme'),
        ...
        add_settings_field(
            'heading_font_weight',
            __('Heading Font Weight', 'ross-theme'),
    ...
    private function add_buttons_section() {
        ...
        add_settings_field(
            'button_bg_color',
            __('Button Background Color', 'ross-theme'),
        ...
        add_settings_field(
            'button_text_color',
            __('Button Text Color', 'ross-theme'),
        ...
        add_settings_field(
            ...
            __('Button Border Radius (px)', 'ross-theme'),
    ...
    private function add_media_section() {
        ...
        add_settings_field(
            'default_logo',
            __('Upload Default Logo', 'ross-theme'),
        ...
        add_settings_field(
            'dark_mode_logo',
            __('Upload Dark Mode Logo', 'ross-theme'),
        ...
        add_settings_field(
            'lazy_load_images',
            __('Lazy Load Images', 'ross-theme'),
    ...
    private function add_blog_section() {
        ...
        add_settings_field(
            'excerpt_length',
            __('Excerpt Length (words)', 'ross-theme'),
    ...
    private function add_performance_section() {
        ...
        add_settings_field(
            'defer_js_loading',
            __('Defer JS Loading', 'ross-theme'),
    ...
    private function add_custom_section() {
        add_settings_section(
            ...
            __('🧰 Custom Uploads / Scripts', 'ross-theme'),
        ...
        add_settings_field(
            'custom_js',
            __('Custom JavaScript', 'ross-theme'),
        ...
        add_settings_field(
            'google_analytics',
            __('Google Analytics Code', 'ross-theme'),
    ...
    public function enable_preloader_callback() {
        ...
        <label for="enable_preloader"><?php _e('Enable page preloader animation', 'ross-theme'); ?></label>
        <?php
    }
